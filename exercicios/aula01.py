# 01.	Imprima a frase "Olá, mundo!" na tela usando a função print.
print('Olá, mundo!')

# 02.	Crie uma variável inteira "x" e imprima seu valor usando a função print.
x = 42
print('x =', x)

# 03.	Crie uma variável float "y" e imprima seu valor usando a função print.
y = 3.14
print('y = ', y)

# 04.	Imprima o resultado da operação 2 + 2 usando a função print.
print('2 + 2 =', 2 + 2)

# 05.	Imprima o resultado da operação 10 - 5 usando a função print.
print('10 - 5 =', 10 - 5)

# 06.	Imprima o resultado da operação 2 * 3 usando a função print.
print('2 * 3 =', 2 * 3)

# 07.	Imprima o resultado da operação 10 / 2 usando a função print.
print('10 / 2 =', 10 / 2)

# 08.	Imprima o resultado da operação 10 // 3 usando a função print.
print('10 // 3 =', 10 // 3)

# 09.	Imprima o resultado da operação 10 % 3 usando a função print.
print('10 % 3 =', 10 % 3)
...
altura = 1.7
print('A altura do Tom Cruise é', altura)
...
mensagem = 'Bem-vindo ai meu programa'
print(mensagem)
...
# 26.	Divida "g" por "h" e some com "d" e "e", armazene o resultado em uma nova variável chamada "i" e mostre o resultado dela.
i = (g / h) + d + e
...
# 29.	Multiplique "k" por "l". Armazene o resultado em uma nova variável chamada "m" e mostre o valor dela.
m = k * l
...
# 32.	Eleve "o" a "n" e armazene o resultado em uma nova variável chamada "p" e mostre o valor dela.
p = o ** n
...
# 35.	Eleve "r" a "q". Armazene o resultado em uma nova variável chamada "s" e mostre o valor dela
s = r ** q
...
# 38.	Divida "t" por "u". Armazene o resultado em uma nova variável chamada "v" e mostre o valor dela.
v = t / u
